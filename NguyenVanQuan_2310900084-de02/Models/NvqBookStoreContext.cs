...
public partial class NvqBookStoreContext : DbContext
{
    public NvqBookStoreContext()
    {
    }

    public NvqBookStoreContext(DbContextOptions<NvqBookStoreContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-JUUBFOA\\SQL2019;Database=NvqBookStore;uid=sa;pwd=1234$; MultipleActiveResultSets=True; TrustServerCertificate=True ");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A6F4D8EBCC");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C20770AC458A");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0BD8BE474D");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCFC549A994");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36C9730B37D");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FAB52E5C723");
